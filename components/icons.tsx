...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6.343 6.343l2.829 2.829m1.414-7.07l2.829 2.828M17.657 6.343l-2.829 2.829m7.072 1.414h-4M19 5v4M12 3v4m-3 11v4m-2-2h4m5.657-2.829l-2.829-2.828M15 21v-4m-3 1.657l-2.829-2.828M6.343 17.657l2.829-2.828" />
  </svg>
);
